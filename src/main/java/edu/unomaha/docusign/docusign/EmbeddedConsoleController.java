...
public class EmbeddedConsoleController extends AbstractEsignatureController {
    ...
    @Autowired
    public EmbeddedConsoleController(DSConfiguration config, Session session, User user) {
