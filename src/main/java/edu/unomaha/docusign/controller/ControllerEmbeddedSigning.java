...
import edu.unomaha.docusign.core.model.User;
 ...
 */
@Controller
@RequestMapping("/EmbeddedSigning")
public class ControllerEmbeddedSigning extends AbstractEsignatureController {
    ...
    @Autowired
    public ControllerEmbeddedSigning(DSConfiguration config, Session session, User user) {
        super(config, "EmbeddedSigning", "Use embedded signing");
    ...
    protected Object doWork(WorkArguments args, ModelMap model,
        ...
        ApiClient apiClient = createApiClient("https://demo.docusign.net/", user.getAccessToken());
    ...
    private RecipientViewRequest makeRecipientViewRequest(String signerEmail, String signerName) {
        ...
        viewRequest.setPingUrl("http://localhost:8080/");
