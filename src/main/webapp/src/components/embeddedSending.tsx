...
export default function EmbeddedSending() {
    return (
        ...
        <div className="form-group">
            ...
            className="form-control" placeholder="email@domain.com">
            </input>
        </div>
        <div className="form-group">
            <label htmlFor="signerName">Signer Name</label>
            <input type="text" id="signerName" placeholder="FirstName LastName" 
            className="form-control" name="signerName"></input>
        </div>
        <div className="form-group">
            <label htmlFor="ccEmail">CC Email</label>
            <input type="email" id="ccEmail" className="form-control"
            name="ccEmail" placeholder="email@domain.com" required></input>
        </div>
        <div className="form-group">
            <label htmlFor="ccName">CC Name</label>
            <input type="text" id="ccName" placeholder="FirstName LastName"
            className="form-control" name="ccName" required></input>
        </div>
